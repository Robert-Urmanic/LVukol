...
<form method="post" action="MainServletPrihlaseni"> <!-- udělat 2 servlety jeden na přihlášení další na registraci -->
    <p>
        ...
        <input type="text" id="jmenoPrihlaseni" name="jmenoPrihlaseni" minlength="2" maxlength="30" value="${jmenoAttribute}" required autofocus>
    </p>
    <p>
        <label for="hesloPrihlaseni">Heslo: </label>
        <input type="password" id="hesloPrihlaseni" name="hesloPrihlaseni" minlength="3" maxlength="30" value="${hesloAttribute}" required>
    </p>
    <p>
